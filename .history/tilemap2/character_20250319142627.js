...
// Desired display size for the character (slightly larger)
const CHARACTER_DISPLAY_SIZE = 80; // Increased from 64 to 80
...
// Character state
const character = {
    x: 5 * window.TILE_SIZE, // Start at tile (5, 5)
...
// Walkable tiles (not used since collision is disabled)
const walkableTiles = [12, 11, 18]; // Grass, Path, Royal-floor

// Collision check (disabled for now)
function isWalkable(x, y) {
    // Temporarily allow movement everywhere
    return true;
    /*
