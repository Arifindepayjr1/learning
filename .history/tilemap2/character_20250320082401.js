...
const CHARACTER_SPEED = 1.5; // Move 4 pixels per frame
...
const spawnRow = parseInt(urlParams.get('spawnRow')) || (window.currentMap === 'tilemap1' ? 15 : window.currentMap === 'tilemap2' ? 4 : 8); // Row 15 for tilemap1, row 4 for tilemap2, row 8 for tilemap3
const spawnCol = parseInt(urlParams.get('spawnCol')) || (window.currentMap === 'tilemap1' ? 0 : window.currentMap === 'tilemap2' ? 12 : 3); // Col 0 for tilemap1, col 12 for tilemap2, col 3 for tilemap3
...
function checkMapTransition() {
    ...
    if (window.currentMap === 'tilemap1') {
        ...
        } else if (tileY === 19 && tileX === 14) { // Transition to tilemap3
    ...
    // No transition logic for tilemap3 (one-way)
}
