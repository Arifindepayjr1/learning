...
const spawnRow = parseInt(urlParams.get('spawnRow')) || (window.currentMap === 'tilemap1' ? 15 : 3);
const spawnCol = parseInt(urlParams.get('spawnCol')) || (window.currentMap === 'tilemap1' ? 0 : 12);
...
const blockingBaseTiles = [1, 2, 3, 4, 5, 6, 7, 8, 13, 16, 21, 22, 23, 31, 32, 36, 51, 57, 59, 60, 77, 89];
...
function checkMapTransition() {
    ...
    if (window.currentMap === 'tilemap1') {
        if (tileY === 2 && tileX === 24) { // Transition to tilemap2
            startTransition('tilemap2.html?spawnRow=3&spawnCol=12');
        }
