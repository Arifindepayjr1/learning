...
const spawnRow = parseInt(urlParams.get('spawnRow')) || (window.currentMap === 'tilemap1' ? 15 : 4); // Default to row 4 for tilemap2
...
const blockingBaseTiles = [1, 2, 3, 4, 5, 6, 7, 8, 13, 16, 21, 22, 23, 31, 32, 36, 57, 59, 60, 77, 89]; // Removed 51
